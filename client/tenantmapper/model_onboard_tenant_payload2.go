...
// checks if the OnboardTenantPayload2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OnboardTenantPayload2{}

// OnboardTenantPayload2 struct for OnboardTenantPayload2
type OnboardTenantPayload2 struct {
...
type _OnboardTenantPayload2 OnboardTenantPayload2
...
func (o OnboardTenantPayload2) MarshalJSON() ([]byte, error) {
...
func (o OnboardTenantPayload2) ToMap() (map[string]interface{}, error) {
...
func (o *OnboardTenantPayload2) UnmarshalJSON(data []byte) (err error) {
	...
	varOnboardTenantPayload2 := _OnboardTenantPayload2{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varOnboardTenantPayload2)

	if err != nil {
		return err
	}

	*o = OnboardTenantPayload2(varOnboardTenantPayload2)

	return err
}

type NullableOnboardTenantPayload2 struct {
	value *OnboardTenantPayload2
	isSet bool
}

func (v NullableOnboardTenantPayload2) Get() *OnboardTenantPayload2 {
	return v.value
}

func (v *NullableOnboardTenantPayload2) Set(val *OnboardTenantPayload2) {
	v.value = val
	v.isSet = true
}

func (v NullableOnboardTenantPayload2) IsSet() bool {
	return v.isSet
}

func (v *NullableOnboardTenantPayload2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOnboardTenantPayload2(val *OnboardTenantPayload2) *NullableOnboardTenantPayload2 {
	return &NullableOnboardTenantPayload2{value: val, isSet: true}
}

func (v NullableOnboardTenantPayload2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOnboardTenantPayload2) UnmarshalJSON(src []byte) error {
	v.isSet = true
